...
module.exports.initMiddleware = function (app) {
  ...
  app.use(cors());
 // require(path.resolve('./server/core/sockets/core.socket'))(app);
};
...
module.exports.initSockets = function (app) {
  serverFiles.sockets.forEach(function (socket) {
    require(path.resolve(socket))(app);
  });
